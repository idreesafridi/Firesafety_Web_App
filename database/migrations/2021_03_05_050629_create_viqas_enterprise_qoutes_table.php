...
class CreateViqasEnterpriseQoutesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('viqas_enterprise_qoutes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('viqas_enterprise_qoutes');
    }
}

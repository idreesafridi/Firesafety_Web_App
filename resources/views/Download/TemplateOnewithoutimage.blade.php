...
<body onload="print()">
			                ...
			                <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 3em!important; width: 100%!important;overflow-wrap: anywhere;">
			                    <thead>
			                        <tr>
										...
										<th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:8%!important" class="text-center"></th>
	...
	<div class="header">
		<img src="{{ asset('assets/header2.jpeg') }}" style="width: 810px; height:100%;" />
	  </div>
		  <!--style="width: 210mm!important;" -->
		  <div class="footer"><img src="{{ asset('assets/footer2.jpeg') }}" style="width: 105%; height:100%;" /></div>

...
<body onload="print()">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" style="width:100%!important">
                                ...
                                @if(isset($Product) && $Product->gst_product > 0)
                                   <tr>
                                        ...
                                        ?>
                                        <td style="background: #fff; border: 1px solid #000;adding-left: 5.5em;;padding: 2px;;font-size:12px!important;"  class="text-right">{{ number_format($allprouctgst, 2) }}</td>
                                    </tr>
                                @endif
                                @if($Invoice->WHT == 'on')
			                        <?php 
			                        ...
			                        ?>
			                        <tr>
			                            <td colspan="{{ ($Invoice->tax_rate > 0 || $Product->gst_product > 0) ? '4' : '4' }}" style="border:none"></td>
    ...
    <div class="header"><img src="{{ asset('assets/header2.jpeg') }}" style="width: 120%; height:100%;" /></div>
    <!--style="width: 210mm!important;" -->
    <div class="footer"><img src="{{ asset('assets/footer2.jpeg') }}" style="width: 100%; height:100%;" /></div>
</div>

...
<body>
   ...
   <div class="col-sm-3">
	...
	<div class="col-sm-5"><h3>Cleared Invoices Show</h3></div>
...
<a href="{{ route('downloadclearedinvoiceshow1', ['data_key' => 'data_value']) }}" id="clearedinvoiceshow1" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download With  Header & Footer</a>
<a href="{{ route('downloadclearedinvoiceshow', ['data_key' => 'data_value']) }}" id="clearedinvoiceshow" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download Without  Header & Footer</a>
</div>

<script>
    document.addEventListener('DOMContentLoaded', function() {
        var viewButton = document.getElementById('clearedinvoiceshow1');
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            var baseUrl = "{{ route('downloadclearedinvoiceshow1') }}";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var viewButton = document.getElementById('clearedinvoiceshow');
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            // Get the base URL for the 'invoicesByStatshow' route
            var baseUrl = "{{ route('downloadclearedinvoiceshow') }}";

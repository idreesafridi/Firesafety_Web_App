...
<div class="fixed-navbar">
    <div class="float-left">
        ...
        <h1 class="page-title">Pending Invoices</h1>
    </div>
</div>
    						...
    						<div class="col-xl-12">
    							<form action="{{ route('filter-invoice') }}" method="GET" class="form-horizontal">
    								<div class="form-group row">
										...
										<div class="col-sm-2">
										<a href="{{ route('pendinginvoicesshow', ['data_key' => 'data_value']) }}" id="viewButton" class="btn btn-primary btn-sm">View</a>
										</div>
    								</div>
    							</form>
    						</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            var baseUrl = "{{ route('pendinginvoicesshow') }}";

...
<body>
   ...
   <div class="col-sm-3">
	...
	<div class="col-sm-5"><h3>Pending Invoices Show</h3></div>
...
<a href="{{ route('downloadpendinginvoiceshow1', ['data_key' => 'data_value']) }}" id="pendinginvoiceshow1" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download With  Header & Footer</a>
<a href="{{ route('downloadpendinginvoiceshow', ['data_key' => 'data_value']) }}" id="pendinginvoiceshow" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download Without  Header & Footer</a>
</div>

<script>
    document.addEventListener('DOMContentLoaded', function() {
        var viewButton = document.getElementById('pendinginvoiceshow1');
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            var baseUrl = "{{ route('downloadpendinginvoiceshow1') }}";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var viewButton = document.getElementById('pendinginvoiceshow');
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            // Get the base URL for the 'invoicesByStatshow' route
            var baseUrl = "{{ route('downloadpendinginvoiceshow') }}";

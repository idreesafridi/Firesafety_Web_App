...
<a href="{{ route('downloadallinvoiceshow1', ['data_key' => 'data_value']) }}" id="allinvoiceshow1" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download With  Header & Footer</a>
<a href="{{ route('downloadallinvoiceshow', ['data_key' => 'data_value']) }}" id="allinvoiceshow" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download Without  Header & Footer</a>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            var baseUrl = "{{ route('downloadallinvoiceshow1') }}";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButton.addEventListener('click', function(e) {
            ...
            // Get the base URL for the 'invoicesByStatshow' route
            var baseUrl = "{{ route('downloadallinvoiceshow') }}";

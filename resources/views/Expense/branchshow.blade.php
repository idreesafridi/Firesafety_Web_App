                            ...
                            <div class="col-12">
                                <table style="white-space: nowrap;font-weight: bolder;font-size: 16px; width:100%!important">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;font-size:12px!important;"> {{ Auth::User()->username }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;padding-left:0px;font-size:12px!important;">{{ Auth::User()->email }}</td>
                          ...
                          @if($expense)
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <br><br><br>
                                    <pre> <br>
                    <strong> Prepiared By:</strong> <u>{{ auth()->user()->username }}</u>
                                    </pre>
                                </div>
                            </div>

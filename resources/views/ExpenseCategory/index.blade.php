								...
								@if($Categories)
									@foreach($Categories as $Category)
										<tr>
											...
											<td>
												<a href="{{ route('ExpenseCategory.edit',$Category->id) }}" style="display: inline-block;color: #000">
													<i class="fa fa-pencil-alt"></i>
												</a>
												<form action="{{ route('ExpenseCategory.destroy', $Category->id) }}" method="POST" style="display: inline-block;">
								                @csrf
								                @method('DELETE')

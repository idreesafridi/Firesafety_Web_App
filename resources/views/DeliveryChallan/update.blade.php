...
<div class="fixed-navbar">
	<div class="float-left">
		...
		<h1 class="page-title">Update Delievery Challan</h1>
	</div>
</div>
<div id="wrapper">
	<div class="main-content">
		<form data-toggle="validator" action="{{ route('DeliveryChallan.update', $Challan->id) }}" method="POST">
		@csrf()
		@method('PATCH')
						...
						<div class="row">
							...
							<div class="form-group col-md-3">
								<select class="form-control select2_1" name="customer_company_name" id="customer_company_name">
									...
									<option value="{{ $cust->company_name }}" <?php echo (!empty($c_company)) ? 'selected' : '';?>>
									    {{ $cust->company_name }}
									</option>
									@endforeach
									@endif
							...
							@if($count == 0)
								<tr>
									...
									<td>
										<input type="text" class="form-control" id="descriptions" name="descriptions[]" placeholder="Product Description" style="height: 40px!important;">
									</td>
									<td>
										<input type="number" class="form-control" id="qty" name="qty[]" placeholder="Quantity" style="height: 40px!important;">
									</td>
									<td>
										<input type="text" class="form-control" id="" name="remarks[]" placeholder="Remarks" style="height: 40px!important;">
									</td>
									<td>
							...
							@if(isset($Challan->customer_id))
    						 	<input type="hidden" name="walkCustomer" value="{{ $customer->id }}">
    						@endif
    						 	<?php
    						 	if(isset($Challan->customer_id)):

                    ...
                    <div class="content" style="padding-left: 50px!important; padding-right: 50px!important">
                        ...
                        <div class="row">
                            ...
                            <div class="no-print" style="text-align:center!important; margin-top: 2em">
                                <a href="{{ route('DeliveryChallanDownload',$Challan->id) }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download With Header & Footer</a>
                                <a href="{{ route('DeliveryChallanDownload2',$Challan->id) }}" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download With Out Header & Footer</a>
                            </div> 
                        </div>
                    </div>
                </td>

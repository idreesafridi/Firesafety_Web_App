...
<html lang="en" >
    <head>
        ...
        <title>
        	{{$quote->id}}
        	@if($quoteCustomer)
	        	-{{$quoteCustomer->company_name}} 
	        	@if(isset($quoteCustomer->city))-{{ $quoteCustomer->city }} 
	        	@endif
        	@endif
        </title>
...
<body>
                ...
                <td>
                    <div class="content" style="padding-left: 20px!important; padding-right: 20px!important">
	                        <div class="row" style="margin-bottom: -2em;">
			                    <div class="col-12">
			                        <table style="white-space: nowrap;font-weight: bolder;font-size: 16px;" style="width: 110%!important;">
			                            <tr>
			                            ...
			                            <tr>
			                                ...
			                                <td colspan="3" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;font-size:12px!important;">
			                                	{{ ($quoteCustomer) ? $quoteCustomer->company_name : 'N/A' }}
			                                </td>
			                                
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:18%;font-size:12px!important;">Date</td>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:40%;font-size:12px!important;">
			                                	{{ date("d/m/Y", strtotime($quote->dated)) }}
			                                </td>
			                            </tr>
			                            
			                            <tr>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:10%;font-size:12px!important;">Address</td>
			                                <td colspan="3" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;padding-left:0px;font-size:12px!important;"> 
			                                	{{ ($quoteCustomer) ? $quoteCustomer->address : 'N/A' }}
			                                </td>
			                            ...
			                            <tr>
    			                            ...
    			                            <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:40%;font-size:12px!important;">{{ Auth::User()->custom_designation }}</td>
			                            ...
			                            <tr>
    			                           ...
    			                           <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:10%;font-size:12px!important;">Ph No</td>
			                                <td colspan="3" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;font-size:12px!important;">
			                                	{{ ($quoteCustomer) ? $quoteCustomer->phone_no : 'N/A' }}</td>
			                                
    		                            	
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:18%;font-size:12px!important;">Our NTN #</td>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:40%;padding-left:0px;font-size:12px!important;">&nbsp;4738498-3</td>
			                            </tr>
			                            
			                            <tr>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:10%;font-size:12px!important;">Att:</td>
			                                <td colspan="3" style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:50%;font-size:12px!important;">
			                                	{{ ($quoteCustomer) ? $quoteCustomer->customer_name : 'N/A' }}</td>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:18%;font-size:12px!important;">Quote Ref:</td>
			                                <td style="padding: 2px;background: #fff; border: 1px solid #000;font-weight:400; width:40%;font-size:12px!important;">{{ $quote->id }}</td>
			                            </tr>
			                        </table>
			                        
			                        <!--<hr style="width:5px; background:red">-->
			                        <h4 style="margin-top: 0.5em!important;font-size:15px!important;">{{$quote->subject}}</h4>
			                        <!--<p>-->
			                        <!--    Sir, <br>-->
			                ...
			                <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 2em!important; width: 100%!important;overflow-wrap: anywhere;">
			                    <thead>
			                        <tr>
			                            ...
			                            <th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:10%!important" class="text-center">Size</th>
			                            <th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:10%!important" class="text-left">Pic</th>
			                            <th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:10%!important" class="text-right">Qty</th>
			                            <th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:10%!important" class="text-center">UOM</th>
			                            <th style="background: #fff; border: 1px solid #000;font-weight:bolder;padding: 2px;text-align: center!important;width:10%!important" class="text-center">Unit/Price</th>
			                    ...
			                    <tbody>    
									...
									@foreach($QouteProducts as $Product)
					                    ...
					                    <tr>
				                            ...
				                            <td style="background: #fff; border: 1px solid #000;font-weight:400;;padding-left: 1px;padding-right: 1px;" class="text-center">
				                                <div style="width:50px; height: 40px; margin-bottom:0px!important">
				                                <img src="/Product/{{ $productData->image }}" style="width:100%!important; height:100%!important;">
				                                </div>
				                            </td>
				                            ...
				                            <td style="background: #fff; border: 1px solid #000;font-weight:400;padding: 2px;" class="text-center">{{ number_format($Product->unit_price,2)  }}</td>
				                            <?php 
				                            // Capacity
										  ...
										  //  endif;
				                            ...
				                            ?>
				                            <td style="background: #fff; border: 1px solid #000;font-weight:400; text-align:right;padding: 1px;" class="text-right">
									...
									<tr>
			                            ...
			                            <td style="background: #fff; border: 1px solid #000;font-weight:400;;padding-left: 1px;padding-right: 1px;" class="text-center">
			                            	...
			                            	<img src="/other_products_image/{{ $other_products_image[$count2] }}" style="width:50px; height: 50px">
			                            	@endif
			                            </td>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="float: right;width: 100%!important;">
								<tfoot>
									...
									@if($quote->tax_rate > 0 OR $quote->transportaion > 0 OR $quote->discount_percent > 0 OR $quote->discount_fixed > 0)
									<tr>
									...
									} elseif ($quote->discount_fixed > 0) {
										$discount_value = $quote->discount_fixed;
									}
									$new_total_price -= $discount_value;
									$Net_Grand = $new_total_price;
									?>
									<tr>
										<td colspan="5" style="border:none"></td>
									...
									<tr>
										<td colspan="5" style="border:none"></td>
										<th colspan="4" style="background: #fff; border: 1px solid #000;font-weight:bolder;color:blue;padding-left: 5.5em;;padding: 2px;width:20%!important">Transportation</th>
			                ...
			                <div><p>{!! $quote->termsConditions !!}</p></div>
			                ...
			                <div class="no-print" style="text-align:center!important">
        			            <a href="{{ route('downloadQuoteOne', $quote->id) }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download with Header & Footer</a>
        			            <a href="{{ route('downloadQuote2', $quote->id) }}" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download with out Header & Footer</a>
        			        </div>
							<br>
							<div class="no-print" style="text-align:center!important">
        			            <a href="{{ route('downloadQuoteOnewithoutimage', $quote->id) }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Without Image Download with Header & Footer</a>
        			            <a href="{{ route('downloadQuoteTwowithoutimage', $quote->id) }}" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Without Image Download with out Header & Footer</a>
        			        </div>
    ...
    <div class="header"><img src="{{ asset('assets/header2.jpeg') }}" style="width: 127%; height: 100px;"/></div>
     <!--style="width: 210mm!important;" -->
    <div class="footer"><img src="{{ asset('assets/footer2.jpeg') }}" style="width: 170mm!important;" /></div>

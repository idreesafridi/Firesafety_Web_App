					...
					<div class="form-group">
						<div class="row">
                            ...
                            <table class="table" id="customerTable">
    							    ...
    							    @foreach($QouteProducts as $QProduct)
    								    ...
    								    <tr>
                                            ...
                                            <th colspan="6">
												...
												<textarea name="description[]" class="form-control description3 txtdescription " placeholder="Description"  style="height: 200px">
								...
								<th colspan="6">
									<a class="btn btn-xs btn-primary view_hide" style="color: #fff;">View/Hide Description</a>
									<textarea name="description[]" class="form-control description " placeholder="Description" style="height: 50px"></textarea>
								</th>
							</tr>
								@endif
							</table>
...
$( document ).ready(function() {
	...
	$("#customerTable").on('click', '.addmore', function(){
		...
		data +='<textarea name="description[]" class="form-control description txtdescription" placeholder="Description" style="height: 50px"></textarea>';
		data += '</div>';
		data +='</th>';
		data +='</tr>';

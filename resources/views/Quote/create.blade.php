...
<form data-toggle="validator" action="{{ route('Quotes.store') }}" method="POST" enctype="multipart/form-data" id="quoteForm">
@csrf()
<div id="wrapper">
						...
						<div class="row">
							...
							<div class="form-group col-md-3">
								<select class="form-control select2_1" name="branch" id="" required>
									<option value="{{(isset($user->branch_id))}}">Select Branch</option>
									@if($Branches)
										@foreach($Branches as $Branch)
											<option value="{{ $Branch->branch_name }}"
												@if(old('branch') == $Branch->branch_name || (isset($user->branch_id) && $user->branch == $Branch->branch_name))
													selected
												@endif
											>
												{{ $Branch->branch_name }}
							...
							<div  class="form-group col-md-2" style="text-align: left;padding: 10;px">
    								<input type="number" class="form-control" id="gst_fixed" name="gst_fixed" value="{{ old('gst_fixed') }}" placeholder="GST Fixed"  style="height: 30px!important;">
    							</div>
							...
							<div class="form-group col-md-12 mt-5">
						  	...
						  	<div class="form-group col-md-12">
								<textarea class="form-control txtdescription" id="txtarea_terms"  name="termsConditions" placeholder="Terms & Conditions">{{ old('termsConditions') }}</textarea>
								<div class="help-block with-errors"></div>
							</div>
						</div>
					</div>

			...
			<div class="row small-spacing">
			    ...
			    <div class="col-12">
    				<div class="box-content">
    					...
    					<div class="row">
    						<div class="col-xl-12">
    							<form action="{{ route('filter-safety-care') }}" method="GET" class="form-horizontal">
								...
								@if($Quotes)
									@foreach($Quotes as $Quote)
										<tr>
											...
											<?php 
											$totalPrice1 = 0;
											$QouteProducts   = App\Models\SafetyCareQouteProducts::where('quote_id', $Quote->id)->get(); 
											...
											<td>
												...
												<a href="{{ route('SafetyCare.show', $Quote->id) }}" target="_blank" style="display: inline-block;color: #000">
													<i class="menu-icon fa fa-download"></i>
												</a>
												
												<form action="{{ route('SafetyCare.destroy', $Quote->id) }}" method="POST" style="display: inline-block;">
								                @csrf
								                @method('DELETE')
											...
											<td>
												<a href="{{ route('SafetyCareQouteExport', $Quote->id) }}">Export</a>
											</td>
										</tr>
									@endforeach
								@endif

            ...
            <tr>
                <td>
                    ...
                    <div class="no-print" style="text-align:center!important">
			            <a href="{{ route('safety_down_with_header', $quote->id) }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download with Header & Footer</a>
			            <a href="{{ route('safety_down_without_header', $quote->id) }}" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download with out Header & Footer</a>
			        </div>
                </td>
            </tr>
        </tbody>

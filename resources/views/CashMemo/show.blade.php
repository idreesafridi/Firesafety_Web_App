...
<body>
                ...
                <td>
                    <div class="content" style="padding-left: 50px!important; padding-right: 50px!important;padding-top: 4rem;">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th style="padding:2px; text-align: center;width:3%!important;font-size:12px!important;">S.No</th>
                                    <th style="padding:2px; text-align: center;width:60%!important;font-size:12px!important;">Descriptions</th>
                                    <th style="padding:2px; text-align: center;width:8%!important;font-size:12px!important;">Size</th>
                                    <th style="padding:2px; text-align: center;width:8%!important;font-size:12px!important;">Qty</th>
                                    <th style="padding:2px; text-align: center;width:15%!important;font-size:12px!important;">Unit Price</th>
                                    <th style="padding:2px; text-align: center;width:15%!important;font-size:12px!important;">Amount</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($CashmemoProducts)
                        ...
                        <div class="no-print" style="text-align:center!important">
                                <a href="{{ route('CashMemoDownload',$CashMemo->id) }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-download"></i>Download With Header & Footer</a>
                                <a href="{{ route('CashMemoDownload2',$CashMemo->id) }}" class="btn btn-xs btn-success" target="_blank"><i class="fa fa-download"></i>Download With Out Header & Footer</a>
                            </div>
                    </div>
                </td>
            </tr>
    ...
    <div class="header"><img src="{{ asset('assets/header2.jpeg') }}" style="width: 116%; height:100%;" /></div>
    <!--style="width: 210mm!important;" -->
<div class="footer"><img src="{{ asset('assets/footer2.jpeg') }}" style="width: 116%; height:100%;" /></div>
</div>

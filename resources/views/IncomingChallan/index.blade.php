...
<div class="fixed-navbar">
    <div class="float-left">
        ...
        <h1 class="page-title">All Incoming Challan</h1>
    </div>
</div>
			...
			<div class="row small-spacing">
			    <div class="col-12">
    				<div class="box-content">
    					...
    					<div class="row">
    						<div class="col-xl-12">
    							<form action="{{ route('filter-incoming-challan') }}" method="GET" class="form-horizontal">
								...
								@if($Challans)
									@foreach($Challans as $Challan)
										<tr>
											...
											<td>
												<a href="{{ route('IncomingChallan.show', $Challan->id) }}" target="_blank">
													<i class="fa fa-eye" style="color: #000"></i>
												</a>
												<a href="{{ route('IncomingChallan.edit', $Challan->id) }}" >
													<i class="fa fa-pencil-alt" style="color: #000"></i>
												</a>
												<form action="{{ route('IncomingChallan.destroy', $Challan->id) }}" method="POST" style="display: inline-block;">
								                @csrf
								                @method('DELETE')
											...
											<td>
											   <a href="{{ route('duplicate-incoming-challan',$Challan->id) }}">Duplicate</a>
											</td>
											<td>

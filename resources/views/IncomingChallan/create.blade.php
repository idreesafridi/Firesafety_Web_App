...
<div class="fixed-navbar">
	<div class="float-left">
		...
		<h1 class="page-title">Create Incoming Challan</h1>
	</div>
</div>
<div id="wrapper">
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-12">
				...
				<h4 class="box-title">Generate Incoming Challan from Quote</h4>
					<form data-toggle="validator" action="{{ route('IncomingChallanStore') }}"  enctype="multipart/form-data" method="POST">
					@csrf()
		...
		<form data-toggle="validator" action="{{ route('IncomingChallan.store') }}" method="POST">
		@csrf()
		<div class="row small-spacing">
			<div class="col-12">

				<div class="box-content">
					<h4 class="box-title">Add Incomming Challan</h4>
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="form-group col-md-3">
								...
								<input type="text" class="form-control" id="customer_order_no" name="customer_order_no" placeholder="Customer Order No" style="height: 30px!important;" value="{{ old('customer_order_no') }}">
								<div class="help-block with-errors"></div>
							</div> 
							<div class="form-group col-md-3">
								<label>Customer Date</label>
								<input type="date" class="form-control" id="customer_order_date" name="customer_order_date" value="{{ old('customer_order_date') }}" style="height: 30px!important;">
								<div class="help-block with-errors"></div>
							</div> 
